...
namespace Cheats
{
    public class AdCheatsProvider : ICheatsProvider
    {
        ...
        public AdCheatsProvider(ICheatService cheatService)
        {
            ...
            _isRewardedAdShownLabel = new CheatLabel(()=> $"Rewarded Inter Shown: {_isRewardedAdShown}");
            ...
            _isInterstitialAdShownLabel = new CheatLabel(()=> $"Inter Shown: {_isInterstitialAdShown}");
            ...
            _isRewardedVideoAdShownLabel = new CheatLabel(()=> $"Rewarded Video Shown: {_isRewardedVideoAdShown}");
        }
